...
var redisLockOptions = builder.Configuration.GetSection(RedisLockOptions.Position).Get<RedisLockOptions>() ??
                       throw new Exception("Failed to find redis options");
...
builder.Services.AddDisturbedRedisLockFactory(redisLockOptions);
