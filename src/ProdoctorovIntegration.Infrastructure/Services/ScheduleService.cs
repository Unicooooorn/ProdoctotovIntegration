...
public class ScheduleService : IScheduleService
{
    ...
    private readonly ISharedMutexManager _sharedMutexManager;
    private readonly HospitalDbContext _dbContext;
    private readonly OrganizationNameOptions _organizationNameOptions;

    public ScheduleService(IClientService clientService, ISharedMutexManager sharedMutexManager, HospitalDbContext dbContext, IOptions<OrganizationNameOptions> organizationNameOptions)
    {
        _clientService = clientService;
        _dbContext = dbContext;
        _sharedMutexManager = sharedMutexManager;
    ...
    public async Task<RecordClientResponse> RecordClientAsync(WorkerDto worker, AppointmentDto appointment, ClientDto client, string appointmentSource, CancellationToken cancellationToken = default)
    {
        ...
        await DoInTransactionWithMutexAsync(async () =>
        {
    ...
    private async Task DoInTransactionWithMutexAsync(Func<Task> action, Guid cellId)
    {
